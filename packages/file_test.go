...
func TestFilePath(t *testing.T) {
	...
	ptr("Dir(p):", filepath.Dir(p))
	ptr("Base(p):", filepath.Base(p))
	...
	ptr(strings.TrimSuffix(filename, ext))
...
func TestDirectories(t *testing.T) {
	...
	ptr("Listing subdir/parent")
	for _, entry := range c {
		ptr(" ", entry.Name(), entry.IsDir())
	}
	...
	ptr("Listing subdir/parent/child")
	for _, entry := range c {
		ptr(" ", entry.Name(), entry.IsDir())
	}
